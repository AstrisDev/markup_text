...
void main() {
  testWidgets('MarkupText widget', (WidgetTester tester) async {
    ...
    expect(textSpan.children, isNot(null));
    ...
    expect((textSpan.children![11] as TextSpan).style!.color,
        Color.fromRGBO(255, 0, 0, 1));
    expect((textSpan.children![13] as TextSpan).style!.color,
  ...
  testWidgets('MarkupText widget with icons', (WidgetTester tester) async {
    ...
    expect((textSpan.children![0] as TextSpan).text,
        "This is a test for the use of the alarm ");
    expect(((textSpan.children![1] as WidgetSpan).child as Icon).icon,
        Icons.access_alarm);
